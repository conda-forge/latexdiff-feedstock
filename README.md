...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/latexdiff-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14562&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/latexdiff-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `latexdiff` can be installed with:

```
conda install latexdiff
```

It is possible to list all of the versions of `latexdiff` available on your platform with:
